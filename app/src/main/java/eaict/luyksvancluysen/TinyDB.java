...
public class TinyDB {
    ...
    public ArrayList<SoundEffects> getListObject(String key, Class<?> mClass){
    	Gson gson = new Gson();

   	ArrayList<String> objStrings = getListString(key);
   	ArrayList<SoundEffects> objects =  new ArrayList<SoundEffects>();

   	for(String jObjString : objStrings){
    		SoundEffects value  = (SoundEffects) gson.fromJson(jObjString,  mClass);
   		objects.add(value);
    	}
   	return objects;
    }
...
//    }
//
 public void putListObject(String key, List<SoundEffects> objArray){
 	checkForNullKey(key);
  	Gson gson = new Gson();
